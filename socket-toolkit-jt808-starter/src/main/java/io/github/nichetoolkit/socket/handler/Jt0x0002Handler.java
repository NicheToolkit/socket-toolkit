...
/**
 * <p>Jt0x0002Handler 终端心跳命令</p>
 * @author Cyan (snow22314@outlook.com)
 * @version v.1.0
 */
@Slf4j
@SocketPackage(messageId = 0x0002)
public class Jt0x0002Handler implements SocketPackageHandler {
    @Autowired
    ...
    public byte[] handle(byte[] phoneBytes, byte[] flowIdBytes, byte[] messageIdBytes, byte[] messageBodyBytes) {
        log.info("[Jt0x0002] 0002 [终端心跳命令] terminal heart beat");
