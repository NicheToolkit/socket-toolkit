...
/**
 * <p>Jt0x0104Handler 查询终端参数应答</p>
 * @author Cyan (snow22314@outlook.com)
 * @version v.1.0
 */
@Slf4j
@SocketPackage(messageId = 0x0104)
public class Jt0x0104Handler implements SocketPackageHandler {
    @Autowired
    ...
    public byte[] handle(byte[] phoneBytes, byte[] flowIdBytes, byte[] messageIdBytes, byte[] messageBodyBytes) {
        log.info("[Jt0x0104] 0104 [查询终端参数] search terminal parameter");
